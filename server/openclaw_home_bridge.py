...
def main():
    ...
    if task == "format_home_message_markdown_lite":
        ...
        prompt = (
            ...
            "Usa #, ##, ### per intestazioni, '-' per liste vere, **parola** per label ovvie (es: Oggi, Domani, BTC, ETH, IOTX, Agenda, Notizie).\nUsa *parola* (asterischi singoli) per evidenziare concetti chiave con colore accent.\n"
            "Usa colori inline nel formato {#RRGGBB}parola{/} SOLO quando serve, soprattutto verde #22C55E per valori positivi e rosso #EF4444 per negativi.\n"
