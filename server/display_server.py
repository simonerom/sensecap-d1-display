...
<screens version="1.4.1">
  ...
  <screen id="home" bg="#1B4F72" grad_color="#4A235A" pad="10">
    <row gap="10" h="310">
      ...
      <col flex="1" gap="10">
        <card bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="16" flex="1">
      ...
      <card bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad_h="8" pad_v="8" gap="4" tight="true" flex="2" h="100%" valign="center">
      ...
      <!-- Right col: tVOC + CO2 -->
      <col flex="1" gap="10">
        <card bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="16" flex="1" valign="center">
    ...
    <card bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="14" w="100%" scroll="true" scrollbar="false" gap="16">
  ...
  <screen id="calendar" bg="#F5F5F5">
    ...
    <card bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="16" w="100%" scroll="true">
      <label text="◉ Prossimi eventi" font="18" color="#1A1A2E" bold="true"/>
      <events_list items="{events}" font="15" color="#1A1A2E" date_color="#00A885"/>
    </card>
    <row gap="12" pad="12">
      <card flex="1" bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="12">
  ...
  <screen id="clock" bg="#F5F5F5">
    ...
    <row gap="12" pad="16">
      <card flex="1" bg="#FFFFFF" bg_opa="160" border_color="#FFFFFF" border_width="2" radius="6" pad="16">
        <label text="▲ Interno" font="13" color="#666666" align="center"/>
